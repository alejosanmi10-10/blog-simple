...
import Personas from '../../components/dashboard/Personas.vue';
import Publicacion from '../../components/dashboard/Publicacion.vue';
import { TraerRanking } from '../../services/interactionService';
import { Imprimir, formatearFecha } from '../../services/axiosSetup';;
